    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('ADMIN', 'Admin'), ('INFLUENCER', 'Influencer'), ('BRAND', 'Brand')], max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('influencer_id', models.IntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            bases=('users.user',),
            managers=[
                ('brand', django.db.models.manager.Manager()),
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
        migrations.CreateModel(
            ...
            bases=('users.user',),
            managers=[
                ('influncer', django.db.models.manager.Manager()),
                ('objects', django.contrib.auth.models.UserManager()),
            ],
        ),
    ]
